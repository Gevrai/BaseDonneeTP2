...
ALTER TABLE Evenement ADD CONSTRAINT CategorieEvenements FOREIGN KEY ( NoCategorie ) REFERENCES Categorie ( NoCategorie ) ;

ALTER TABLE Client ADD CONSTRAINT ClientAddresse FOREIGN KEY ( NoAdresse ) REFERENCES Adresse ( NoAdresse ) ;
...
ALTER TABLE Emplacement ADD CONSTRAINT EmplacementAddresse FOREIGN KEY ( NoAdresse ) REFERENCES Adresse ( NoAdresse ) ;
