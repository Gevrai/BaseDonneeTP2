...
CREATE OR REPLACE TRIGGER FKNTO_Categorie BEFORE
  UPDATE OF Parent ON Categorie FOR EACH ROW BEGIN IF :old.Parent IS NOT NULL THEN raise_application_error(-20225,'Non Transferable FK constraint Sous-categorie on table Categorie is violated');
END IF;
END;
/
